...
public class Blur extends AbstractKernelFilter {
  ...
  /**
   * Constructor to create the blur object to use with the picture.
   */
  public Blur() {
    // empty constructor, no fields. Gives us access to see Blur elsewhere.
  }

  /**
   * Take the image and put a blur filter on it.
   *
  ...
  @Override
  public IImage applyKernel(double[][] kernel, IImage picture) {
