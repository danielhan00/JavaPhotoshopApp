...
/**
 * A class to change a image's color to be greyscale.
 */
public class Greyscale extends AbstractColorFilter {

  /**
   * Constructor to create the greyscale object to use with the picture.
   */
  public Greyscale() {
    // empty constructor, no fields. Gives us access to see Greyscale elsewhere.
  }

  /**
   * Take the image and put a greyscale filter on it.
